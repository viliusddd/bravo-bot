...
describe('GET', () => {
  ...
  it('should return a list of existing sprints', async () => {
    ...
    await createSprints([
      ...
      fakeSprint({
        code: 'WD-2.1.5',
        title: 'HTML and CSS - the Foundation of Web Pages'
      })
    ])
    ...
    //     title: 'First Steps Into Programming with Python', // our default title, code generated by fakeSprint
    //     code: 'WD-1.1.5',
    //   },
    //   {
...
describe('POST', () => {
  ...
  it('does not allow to create an sprint with empty code', async () => {
    const {body} = await supertest(app)
      .post('/sprints')
